...
import com.onlinebookstore.utility.MailConstructor;
...
public class HomeController {
	...
	public String forgetPassword(
		...
		SimpleMailMessage newEmail = mailConstructor.constructResetTokenMail(appUrl, request.getLocale(), token, user, password);
